...
expiration_date TEXT NOT NULL
    ...
    def remove_item(self, email: str, item: str, quantity: int, expiration_date: str) -> None:
        """
        Inserts food item, quantity, and expiration of food item in refrigerator
        """

        try:
            INSERT_SQL = f"DELETE FROM INVENTORY WHERE email='{email}' AND item='{item}' AND '{quantity}', '{expiration_date}')"
            self.cursor.execute(INSERT_SQL)
